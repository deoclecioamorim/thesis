...
setwd('C:/Study/MSC_Project/comparison simulations one random slope/sample 25')
...
settings1 <- c(sample_size=25,rep=5,beta0=1,beta1=2,sqrt_phi_22=0.15)
settings2 <- c(sample_size=25,rep=5,beta0=1,beta1=2,sqrt_phi_22=0.3)
settings3 <- c(sample_size=25,rep=5,beta0=1,beta1=2,sqrt_phi_22=0.45)
settings4 <- c(sample_size=25,rep=5,beta0=1,beta1=2,sqrt_phi_22=0.6)
...
write.csv(testResults,"comparison_one_slope_sample25.csv")
